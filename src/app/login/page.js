...
export default function Login() {
    ...
    return (
        <>
            ...
            {/* Added Register button below */}
            <div className="mt-4 text-center">  {/* <-- Added container for Register link */}
                <p>Don't have an account?</p>
                <Link href="/register" className="text-blue-500">  {/* <-- Added Link component to navigate to /register */}
                    Register
                </Link>
            </div>
        </>
